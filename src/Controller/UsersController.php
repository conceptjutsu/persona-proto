...
class UsersController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Genders', 'Roles', 'Statuses', 'Stations', 'ParentUsers'],
        ];
    ...
    public function view($id = null)
    {
        $user = $this->Users->get($id, [
            'contain' => ['Genders', 'Roles', 'Statuses', 'Stations', 'ParentUsers', 'ChildUsers'],
        ]);
    ...
    public function add()
    {
        ...
        $this->set(compact('user', 'genders', 'roles', 'statuses', 'stations', 'parentUsers'));
    }
