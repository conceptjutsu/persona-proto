...
class AreasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'municipality_id_idx' => ['type' => 'index', 'columns' => ['municipality_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'municipality_id' => ['type' => 'foreign', 'columns' => ['municipality_id'], 'references' => ['municipalities', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
